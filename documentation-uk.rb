...
module Doc
  documentation_define :vocab,
  {
    ...
    :desc      => "RME is a powerful tool to improve your RPGMaker VXAce experience!",
    :index     => "Documentation",
    #class
    :cl_title  => "Classes and modules",
    #methods
    :m_desc    => "Description of the methods",
    :m_list    => "Method's list",
    #commands
    :cmd_title => "Commands",
    :cmd_desc  => "Commands descritpion",
    :cmd_list  => "Command's list",
    #labels
    :l_attr    => "Attributes",
    :l_name    => "Name",
    :l_type    => "Type",
    ...
    :undocumented => "Undocumented commands",
    :orphans      => "Unknown commands",
    :suggest      => "Suggestion",
  }
  documentation_add_link "GitHub", "https://github.com/funkywork/RME"
  documentation_add_link "Manual (Wiki)", "https://github.com/funkywork/RME/wiki"
end
